...
- A **new topic** that supports a scenario the agent does not currently handle  
- Additional **routing logic** based on user intent or opportunity data  
- A **multi-turn conversation** that gathers more context before responding  
- An improvement to an existing topic that makes the output more useful, clearer, or more realistic  

There is no single correct solution. This task is intentionally open-ended.
